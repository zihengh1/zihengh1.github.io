...
\section{\textbf{\textcolor{blue}{Res}earch Experience}}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Modeling Models in the Model Marketplace} \\
          {- Designed trading mechanisms for multiple agents to transfer knowledge and optimize agents' utilities.} \\
        ...
        \resumeItem{AutoWS-Bench-101: Benchmarking Automated Weak Supervision with 100 Labels [3]} \\
          {- Contributed a new \href{https://arxiv.org/pdf/2208.14362.pdf}{\underline{benchmark}} to evaluate automated WS techniques with diverse application domains.} \\
        \resumeItem{ScriptoriumWS: A Code Generation Assistant for Weak Supervision [4]} \\
          {- Developed prompting strategies with \textbf{code generation model} to synthesized labeling functions in WS.} \\
      \resumeItemListEnd
